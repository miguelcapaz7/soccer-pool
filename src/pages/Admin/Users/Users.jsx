      ...
      <div className="container mt-4">
        {loading ? (
          ...
          <>
            ...
            <div className="d-none d-md-block table-responsive rounded-3 shadow-sm border small">
    <table className="table align-middle mb-0">
      <thead className="table-dark" style={{ letterSpacing: "0.3px" }}>
        <tr>
      ...
      <tbody>
        {users.map((u) => (
          <tr
            key={u.id}
            style={{
              "--bs-table-bg": u.picksSubmitted ? "#e5f9cc" : "transparent",
            }}
          >
