    ...
    return (
      <div className="col">
        ...
        <table className="table table-bordered mb-2 table-hover">
          ...
          <tbody>
            {GroupsData.map((groupData, groupIndex) => {
              ...
              return matchups.map(([i, j], matchIndex) => {
                const matchId = `MD${matchDay}-G${groupData.group}-${
                  matchIndex + 1
                }`;
                  ...
                  <tr key={matchId}>
                    ...
                    <td
                      className={`clickable text-center ${
                        selected === teams[i] ? "table-primary" : ""
                      }`}
                    ...
                    <td
                      className={`clickable text-center ${
                        selected === teams[j] ? "table-primary" : ""
                      }`}
                      style={{ cursor: "pointer" }}
